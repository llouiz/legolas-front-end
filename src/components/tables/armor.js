...
class Armor extends Component { 
    ...
    saveArmor = (e) => {
        e.preventDefault();
        let armor = { name: this.state.name, price: this.state.price, destroyable: this.state.destroyable, droppable: this.state.droppable, tradeable: this.state.tradeable};
    ...
    fetchArmorById(armorId) {
        ArmorService.fetchArmorById(armorId)
            .then((res) => {
    ...
    editArmor = (e) => {
        e.preventDefault();
        let armor = { id: this.state.id, name: this.state.name, price: this.state.price, destroyable: this.state.destroyable, droppable: this.state.droppable, tradeable: this.state.tradeable};
                        ...
                        <div class="container">
                            <div class="table-wrapper table-responsive">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Armor's <b>Table</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="#addArmorModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Armor</span></a>
                                            <a href="#deleteAllArmorsModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            this.state.Armors.map(
                                                armor =>
                                                    <tr id={armor.id}>
                                                        ...
                                                        <td>
                                                            <a href="#editArmorModal" class="edit" data-toggle="modal" onClick={() => this.fetchArmorById(armor.id)}><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                            <a href="#deleteArmorModal" class="delete" data-toggle="modal" onClick={() => i = armor.id}><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
                                            )
                                        }
                                    ...
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>Price</label>
                                                    <input type="number" id="price" name="price" value={this.state.price} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Destroyable</label>
                                                    <input type="text" id="destroyable" name="destroyable" value={this.state.destroyable} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="tradeable" name="tradeable" value={this.state.tradeable} onChange={this.onChange} class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
                                                <input type="submit" class="btn btn-success" onClick={this.saveArmor} value="Add"></input>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        <form id="myForm">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-info" onClick={this.editArmor} value="Save" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
                                                <input type="submit" class="btn btn-danger" value="Delete" onClick={() => this.deleteArmor(i)} />
                                            </div>
                                        </form>
                                    </div>
                                </div>
