...
class Player extends Component {
  ...
  fetchPlayerById(playerId) {
    PlayerService.fetchPlayerById(playerId).then((res) => {
                  ...
                  <tbody>
                    {this.state.players.map((player) => (
                      <tr id={player.id}>
                        ...
                        <td>
                          {<img src={player.imgURL} alt="img not found" />}
                        </td>
                        ...
                        <td>
                          <a
                            href="#editPlayerModal"
                            class="edit"
                            data-toggle="modal"
                            onClick={() => this.fetchPlayerById(player.id)}
                          >
                            <i
