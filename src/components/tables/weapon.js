...
class Weapon extends Component { 
    ...
    saveWeapon = (e) => {
        e.preventDefault();
        let weapon = { name: this.state.name, atk_speed: this.state.atk_speed, c_damage: this.state.c_damage, droppable: this.state.droppable, level: this.state.level};
    ...
    fetchWeaponById(weaponId) {
        WeaponService.fetchWeaponById(weaponId)
            .then((res) => {
    ...
    editWeapon = (e) => {
        e.preventDefault();
        let weapon = { id: this.state.id, name: this.state.name, atk_speed: this.state.atk_speed, c_damage: this.state.c_damage, droppable: this.state.droppable, level: this.state.level};
                        ...
                        <div class="container">
                            <div class="table-wrapper table-responsive">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Weapon's <b>Table</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="#addWeaponModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Weapon</span></a>
                                            <a href="#deleteAllWeaponsModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            this.state.Weapons.map(
                                                weapon =>
                                                    <tr id={weapon.id}>
                                                        ...
                                                        <td>{weapon.level}</td>
                                                        <td>
                                                            <a href="#editWeaponModal" class="edit" data-toggle="modal" onClick={() => this.fetchWeaponById(weapon.id)}><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                            <a href="#deleteWeaponModal" class="delete" data-toggle="modal" onClick={() => i = weapon.id}><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
                                            )
                                        }
                                        ...
                                        <form>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control" id="name" name="name" value={this.state.name} onChange={this.onChange} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Attack Speed</label>
                                                    <input type="text" id="atk_speed" name="atk_speed" value={this.state.atk_speed} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Critical Damage</label>
                                                    <input type="number" id="c_damage" name="c_damage" value={this.state.c_damage} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Droppable</label>
                                                    <input type="text" id="droppable" name="droppable" value={this.state.droppable} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Level</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-success" onClick={this.saveWeapon} value="Add"></input>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        <form id="myForm">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input type="text" class="form-control" id="name" name="name" value={this.state.name} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Attack Speed</label>
                                                    <input type="text" id="atk_speed" name="atk_speed" class="form-control" value={this.state.atk_speed} onChange={this.onChange} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Critical Damage</label>
                                                    <input type="number" id="c_damage" name="c_damage" class="form-control" value={this.state.c_damage} onChange={this.onChange} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Droppable</label>
                                                    <input type="text" id="droppable" name="droppable" class="form-control" value={this.state.droppable} onChange={this.onChange} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Level</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-info" onClick={this.editWeapon} value="Save" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
                                                <input type="submit" class="btn btn-danger" value="Delete" onClick={() => this.deleteWeapon(i)} />
                                            </div>
                                        </form>
                                    </div>
                                </div>
