...
class NPC extends Component { 
    ...
    saveNPC = (e) => {
        e.preventDefault();
        let npc = { name: this.state.name, atk_speed: this.state.atk_speed, c_damage: this.state.c_damage, level: this.state.level};
    ...
    editNPC = (e) => {
        e.preventDefault();
        let npc = { id: this.state.id, name: this.state.name, atk_speed: this.state.atk_speed, c_damage: this.state.c_damage, level: this.state.level};
                        ...
                        <div class="container">
                            <div class="table-wrapper table-responsive">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>NPC's <b>Table</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                                            <a href="#addNPCModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New NPC</span></a>
                                            <a href="#deleteAllNPCModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Delete</span></a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            this.state.NPCs.map(
                                                npc =>
                                                    <tr id={npc.id}>
                                                        ...
                                                        <td>{npc.level}</td>
                                                        <td>
                                                            <a href="#editNPCModal" class="edit" data-toggle="modal" onClick={() => this.fetchNPCById(npc.id)}><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                            <a href="#deleteNPCModal" class="delete" data-toggle="modal" onClick={() => i =npc.id}><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                        </td>
                                                    </tr>
                                            )
                                        }
                                        ...
                                        <form>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="atk_speed" name="atk_speed" value={this.state.atk_speed} onChange={this.onChange} class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-success" onClick={this.saveNPC} value="Add"></input>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        <form id="myForm">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>Attack Speed</label>
                                                    <input type="number" id="atk_speed" name="atk_speed" class="form-control" value={this.state.atk_speed} onChange={this.onChange} required />
                                                </div>
                                                <div class="form-group">
                                                    <label>Critical Damage</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" class="btn btn-info" onClick={this.editNPC} value="Save" />
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form>
                                            ...
                                            <div class="modal-footer">
                                                <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" />
                                                <input type="submit" class="btn btn-danger" value="Delete" onClick={() => this.deleteNPC(i)} />
                                            </div>
                                        </form>
                                    </div>
                                </div>
