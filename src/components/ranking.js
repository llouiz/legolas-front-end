        ...
        return (
            <div>
                <section id="container">
                            ...
                            <div id="contain-all" class=" slideout-panel">
                                <section class="leaderboard-progress">
                                    <div class="contain text-center">
                                        <img alt="Legolas Top Kill" class="mb-2" src="https://d125fmws0bore1.cloudfront.net/assets/svgs/icon_trophy_leaderboard-3442a4b2312e6cdd02aa9870e636dc082890277a6267c4ed986a750fef7cbb35.svg" />
                                        <h2>Top Kill Players</h2>
                                        <p class="lead">Here's a list of our top kill players on the leaderboard.</p>
                                    </div>
                                </section>
                                                ...
                                                player =>
                                                    <div class="ranking-table">
                                                        <div class="ranking-table-header-row">
                                                            ...
                                                            <div class="ranking-table-header-data h6">Kills</div>
                                                            <div style={{position: 'relative', marginRight: '50px'}} class="ranking-table-header-data h6">Level</div>
                                                        </div>
                                                        ...
                                                        {c == 1 ?
                                                            <div class="ranking-table-row-leader-1">
                                                                ...
                                                                <div style={{ marginLeft: '115px', position: 'relative', top: '10px' }} class="ranking-table-data">
                                                                    {player.charname}

                                                                    <div style={{ marginLeft: '195px', position: 'relative', bottom: '18px' }}>
                                                                        {player.kills}
                                                                    </div>
                                                                </div>
                    ...
                    <footer className="site-footer" style={{marginTop: '585px'}}>
